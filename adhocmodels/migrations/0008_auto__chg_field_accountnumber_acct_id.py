...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('acct_numb', 'acct_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10))

    def backwards(self, orm):

        # Changing field 'AccountNumber.acct_id'
        db.alter_column('acct_numb', 'acct_id', self.gf('django.db.models.fields.CharField')(max_length=3, unique=True))
