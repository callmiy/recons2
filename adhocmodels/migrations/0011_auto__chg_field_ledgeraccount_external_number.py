...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LedgerAccount.external_number'
        db.alter_column('ledger_acct', 'external_number', self.gf('django.db.models.fields.related.ForeignKey')(null=True, db_column='external_number', to=orm['adhocmodels.NostroAccount']))

    def backwards(self, orm):

        # Changing field 'LedgerAccount.external_number'
        db.alter_column('ledger_acct', 'external_number', self.gf('django.db.models.fields.related.ForeignKey')(db_column='external_number', to_field='number', to=orm['adhocmodels.NostroAccount'], null=True))
