...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountNumber.acct_id'
        db.add_column('acct_numb', 'acct_id',
                      self.gf('django.db.models.fields.CharField')(max_length=3, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountNumber.acct_id'
        db.delete_column('acct_numb', 'acct_id')


    models = {
        'adhocmodels.accountnumber': {
            'Meta': {'ordering': "('owner', 'nuban')", 'object_name': 'AccountNumber', 'db_table': "'acct_numb'"},
            'acct_id': ('django.db.models.fields.CharField', [], {'max_length': '3', 'unique': 'True', 'null': 'True'}),
