...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'NostroAccount', fields ['bank', 'ccy', 'number']
        db.create_unique('nostro_acct', ['bank', 'ccy', 'number'])


    def backwards(self, orm):
        # Removing unique constraint on 'NostroAccount', fields ['bank', 'ccy', 'number']
        db.delete_unique('nostro_acct', ['bank', 'ccy', 'number'])
