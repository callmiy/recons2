...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AccountNumber.acct_id'
        db.alter_column('acct_numb', 'acct_id', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=3))

    def backwards(self, orm):

        # Changing field 'AccountNumber.acct_id'
        db.alter_column('acct_numb', 'acct_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=3, null=True))

    models = {
        'adhocmodels.accountnumber': {
            'Meta': {'ordering': "('owner', 'nuban')", 'object_name': 'AccountNumber', 'db_table': "'acct_numb'"},
            'acct_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '3'}),
