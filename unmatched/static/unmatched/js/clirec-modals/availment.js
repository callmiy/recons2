...
(function() {
  var $lcAvailForm, $lcNumber, $memoAcct, $nostroAcct, $tr, clirecDataObj, dataIsCorrect, lcNumberIsCorrect, memoAcctIsCorrect, memoAcctText, summaryText;
  ...
  memoAcctIsCorrect = function() {
    var ccy;
    if ($memoAcct.val() !== String(clirecUploadUtils.nostroObj.defaultMemoAcct.id)) {
      return false;
    }
    if (!/^\d+$/.test($memoAcct.val())) {
      return false;
    }
    ...
    'submit': function(evt) {
      ...
      return $.ajax({
        ...
        error: function(resp) {
          ...
          return console.log('availment fails = ', resp.responseText || resp);
        }
      });
    }
  });
