...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UnmatchedClarec.created_on'
        db.delete_column('clirec', 'created_on')


    def backwards(self, orm):
        # Adding field 'UnmatchedClarec.created_on'
        db.add_column('clirec', 'created_on',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 7, 6, 0, 0), blank=True),
                      keep_default=False)
