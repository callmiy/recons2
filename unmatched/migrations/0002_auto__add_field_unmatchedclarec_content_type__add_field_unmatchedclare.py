...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnmatchedClarec.content_type'
        db.add_column('clirec', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'UnmatchedClarec.object_id'
        db.add_column('clirec', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UnmatchedClarec.content_type'
        db.delete_column('clirec', 'content_type_id')

        # Deleting field 'UnmatchedClarec.object_id'
        db.delete_column('clirec', 'object_id')
