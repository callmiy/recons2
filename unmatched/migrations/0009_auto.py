...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field clirecs on 'TakenToMemo'
        m2m_table_name = db.shorten_name('taken2memo_clirecs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('takentomemo', models.ForeignKey(orm[u'unmatched.takentomemo'], null=False)),
            ('unmatchedclarec', models.ForeignKey(orm[u'unmatched.unmatchedclarec'], null=False))
        ))
        db.create_unique(m2m_table_name, ['takentomemo_id', 'unmatchedclarec_id'])


    def backwards(self, orm):
        # Removing M2M table for field clirecs on 'TakenToMemo'
        db.delete_table(db.shorten_name('taken2memo_clirecs'))
    ...
    models = {
        ...
        u'unmatched.takentomemo': {
            ...
            'clirecs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['unmatched.UnmatchedClarec']", 'symmetrical': 'False'}),
