...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IbdInt.unmatched'
        db.add_column('ibd_int', 'unmatched',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='unmatched_itfs', null=True, to=orm['unmatched.UnmatchedRecons']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IbdInt.unmatched'
        db.delete_column('ibd_int', 'unmatched_id')
