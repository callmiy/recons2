...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LCCoverMovement.amount'
        db.add_column('lc_cv_mvt', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'LCCoverMovement.memo_acct'
        db.add_column('lc_cv_mvt', 'memo_acct',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['adhocmodels.LedgerAccount']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LCCoverMovement.amount'
        db.delete_column('lc_cv_mvt', 'amount')

        # Deleting field 'LCCoverMovement.memo_acct'
        db.delete_column('lc_cv_mvt', 'memo_acct_id')
