...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'LCCoverMovement', fields ['lc_number', 'acct', 'date_entry_passed', 'amount']
        db.create_unique('lc_cv_mvt', ['lc_number', 'acct_id', 'date_entry_passed', 'amount'])


    def backwards(self, orm):
        # Removing unique constraint on 'LCCoverMovement', fields ['lc_number', 'acct', 'date_entry_passed', 'amount']
        db.delete_unique('lc_cv_mvt', ['lc_number', 'acct_id', 'date_entry_passed', 'amount'])
    ...
    models = {
        ...
        u'lcavail.lccovermovement': {
            'Meta': {'unique_together': "(('lc_number', 'acct', 'date_entry_passed', 'amount'),)", 'object_name': 'LCCoverMovement', 'db_table': "'lc_cv_mvt'"},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lc_number': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'memo_acct': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['adhocmodels.LedgerAccount']"}),
