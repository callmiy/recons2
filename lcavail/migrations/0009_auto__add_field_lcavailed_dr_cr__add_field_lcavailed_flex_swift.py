...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LcAvailed.dr_cr'
        db.add_column('lc_availed', 'dr_cr',
                      self.gf('django.db.models.fields.CharField')(default='X', max_length=1),
                      keep_default=False)

        # Adding field 'LcAvailed.flex_swift'
        db.add_column('lc_availed', 'flex_swift',
                      self.gf('django.db.models.fields.CharField')(default='X', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LcAvailed.dr_cr'
        db.delete_column('lc_availed', 'dr_cr')

        # Deleting field 'LcAvailed.flex_swift'
        db.delete_column('lc_availed', 'flex_swift')
