...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LcAvailed.clarec_detail'
        db.add_column('lc_availed', 'clarec_detail',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LcAvailed.clarec_detail'
        db.delete_column('lc_availed', 'clarec_detail')
