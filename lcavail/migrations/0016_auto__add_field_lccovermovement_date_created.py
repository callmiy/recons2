...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LCCoverMovement.date_created'
        db.add_column('lc_cv_mvt', 'date_created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 6, 16, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LCCoverMovement.date_created'
        db.delete_column('lc_cv_mvt', 'date_created')
