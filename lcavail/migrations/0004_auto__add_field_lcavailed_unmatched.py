...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LcAvailed.unmatched'
        db.add_column('lc_availed', 'unmatched',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='unmatched_lcees', null=True, to=orm['unmatched.UnmatchedRecons']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LcAvailed.unmatched'
        db.delete_column('lc_availed', 'unmatched_id')
