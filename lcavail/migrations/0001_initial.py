...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LcAvailed'
        db.create_table('lc_availed', (
            ...
            ('date_negotiated', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('bank', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.OverseasBank'], db_column='bank')),
            ('nostro_acct', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.NostroAccount'], db_column='nostro_acct')),
            ('memo_acct', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.LedgerAccount'], db_column='memo_acct')),
            ('avail_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('date_processed', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('drawn_amt', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('entry_seq', self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True, blank=True)),
        ))
        db.send_create_signal('lcavail', ['LcAvailed'])


    def backwards(self, orm):
        # Deleting model 'LcAvailed'
        db.delete_table('lc_availed')
