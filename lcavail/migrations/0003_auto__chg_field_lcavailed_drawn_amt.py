...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LcAvailed.drawn_amt'
        db.alter_column('lc_availed', 'drawn_amt', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'LcAvailed.drawn_amt'
        db.alter_column('lc_availed', 'drawn_amt', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))
