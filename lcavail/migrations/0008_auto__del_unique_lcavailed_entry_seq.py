...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LcAvailed', fields ['entry_seq']
        db.delete_unique('lc_availed', ['entry_seq'])


    def backwards(self, orm):
        # Adding unique constraint on 'LcAvailed', fields ['entry_seq']
        db.create_unique('lc_availed', ['entry_seq'])
