...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LcAvailed.bank'
        db.delete_column('lc_availed', 'bank')

        # Deleting field 'LcAvailed.ccy'
        db.delete_column('lc_availed', 'ccy')


    def backwards(self, orm):
        # Adding field 'LcAvailed.bank'
        db.add_column('lc_availed', 'bank',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.OverseasBank'], null=True, db_column='bank'),
                      keep_default=False)

        # Adding field 'LcAvailed.ccy'
        db.add_column('lc_availed', 'ccy',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.Currency'], null=True, db_column='ccy'),
                      keep_default=False)
