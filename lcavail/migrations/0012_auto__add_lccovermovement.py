...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LCCoverMovement'
        db.create_table('lc_cv_mvt', (
            ...
            ('date_entry_passed', self.gf('django.db.models.fields.DateField')(null=True)),
            ('swift_text', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'lcavail', ['LCCoverMovement'])


    def backwards(self, orm):
        # Deleting model 'LCCoverMovement'
        db.delete_table('lc_cv_mvt')
    ...
    models = {
        ...
        u'lcavail.lccovermovement': {
            'Meta': {'object_name': 'LCCoverMovement', 'db_table': "'lc_cv_mvt'"},
