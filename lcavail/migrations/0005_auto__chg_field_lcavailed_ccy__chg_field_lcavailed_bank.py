...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LcAvailed.ccy'
        db.alter_column('lc_availed', 'ccy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.Currency'], null=True, db_column='ccy'))

        # Changing field 'LcAvailed.bank'
        db.alter_column('lc_availed', 'bank', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.OverseasBank'], null=True, db_column='bank'))

    def backwards(self, orm):

        # Changing field 'LcAvailed.ccy'
        db.alter_column('lc_availed', 'ccy', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['adhocmodels.Currency'], db_column='ccy'))

        # Changing field 'LcAvailed.bank'
        db.alter_column('lc_availed', 'bank', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['adhocmodels.OverseasBank'], db_column='bank'))
    ...
    models = {
        ...
        'lcavail.lcavailed': {
            ...
            'bank': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['adhocmodels.OverseasBank']", 'null': 'True', 'db_column': "'bank'"}),
            'ccy': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['adhocmodels.Currency']", 'null': 'True', 'db_column': "'ccy'"}),
            ...
            'unmatched': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'unmatched_lcees'", 'null': 'True', 'to': "orm['unmatched.UnmatchedRecons']"})
        },
