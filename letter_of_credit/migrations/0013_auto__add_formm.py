...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FormM'
        db.create_table('form_m', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=13)),
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.Customer'])),
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.Currency'])),
        ...
        db.send_create_signal('letter_of_credit', ['FormM'])


    def backwards(self, orm):
        # Deleting model 'FormM'
        db.delete_table('form_m')
