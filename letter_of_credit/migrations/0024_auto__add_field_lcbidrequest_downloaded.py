...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LcBidRequest.downloaded'
        db.add_column('lc_bid_request', 'downloaded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LcBidRequest.downloaded'
        db.delete_column('lc_bid_request', 'downloaded')
    ...
    models = {
        ...
        'letter_of_credit.formm': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lc': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'form_m'", 'null': 'True', 'to': "orm['letter_of_credit.LCRegister']"}),
        ...
        'letter_of_credit.lcbidrequest': {
            ...
            'requested_at': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'})
        },
