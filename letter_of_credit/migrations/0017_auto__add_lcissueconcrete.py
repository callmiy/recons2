...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LCIssueConcrete'
        db.create_table('lc_issue_concrete', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['letter_of_credit.LCIssue'])),
            ('lc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['letter_of_credit.LCRegister'])),
            ('created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('closed_at', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('letter_of_credit', ['LCIssueConcrete'])


    def backwards(self, orm):
        # Deleting model 'LCIssueConcrete'
        db.delete_table('lc_issue_concrete')
    ...
    models = {
        ...
        'letter_of_credit.lcissueconcrete': {
            ...
            'lc': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['letter_of_credit.LCRegister']"})
        },
