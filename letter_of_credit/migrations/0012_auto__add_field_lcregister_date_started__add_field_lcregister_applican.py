...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LCRegister.date_started'
        db.add_column('lc_register', 'date_started',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(1970, 1, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'LCRegister.applicant_obj'
        db.add_column('lc_register', 'applicant_obj',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='lc_register_obj', null=True, to=orm['adhocmodels.Customer']),
                      keep_default=False)

        # Adding field 'LCRegister.brn_obj'
        db.add_column('lc_register', 'brn_obj',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.Branch'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'LCRegister.sector'
        db.add_column('lc_register', 'sector',
                      self.gf('django.db.models.fields.CharField')(max_length=11, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LCRegister.date_started'
        db.delete_column('lc_register', 'date_started')

        # Deleting field 'LCRegister.applicant_obj'
        db.delete_column('lc_register', 'applicant_obj_id')

        # Deleting field 'LCRegister.brn_obj'
        db.delete_column('lc_register', 'brn_obj_id')

        # Deleting field 'LCRegister.sector'
        db.delete_column('lc_register', 'sector')
