...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LCIssueConcrete.closed_at'
        db.alter_column('lc_issue_concrete', 'closed_at', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'LCIssueConcrete.closed_at'
        db.alter_column('lc_issue_concrete', 'closed_at', self.gf('django.db.models.fields.DateField')(default=None))
