...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('letter_of_credit', 'mf', self.gf('django.db.models.fields.CharField')(unique=True, max_length=13))

    def backwards(self, orm):

        # Changing field 'LetterOfCredit.mf'
        db.alter_column('letter_of_credit', 'mf', self.gf('django.db.models.fields.CharField')(max_length=12, unique=True))
    ...
    models = {
        ...
        u'letter_of_credit.letterofcredit': {
            ...
            'mf': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '13'})
        }
    }
