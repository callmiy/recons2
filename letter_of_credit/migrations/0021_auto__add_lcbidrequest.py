...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LcBidRequest'
        db.create_table('lc_bid_request', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mf', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bids', to=orm['letter_of_credit.FormM'])),
            ('created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('requested_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
        ))
        db.send_create_signal('letter_of_credit', ['LcBidRequest'])


    def backwards(self, orm):
        # Deleting model 'LcBidRequest'
        db.delete_table('lc_bid_request')
    ...
    models = {
        ...
        'letter_of_credit.formm': {
            'Meta': {'ordering': "('-date_received',)", 'object_name': 'FormM', 'db_table': "'form_m'"},
        ...
        'letter_of_credit.lcbidrequest': {
            'Meta': {'object_name': 'LcBidRequest', 'db_table': "'lc_bid_request'"},
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'created_at': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mf': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bids'", 'to': "orm['letter_of_credit.FormM']"}),
            'requested_at': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        ...
        'letter_of_credit.lcissueconcrete': {
            ...
            'mf': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'form_m_issues'", 'to': "orm['letter_of_credit.FormM']"})
        },
