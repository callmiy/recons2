...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FormM', fields ['number']
        db.create_unique('form_m', ['number'])


    def backwards(self, orm):
        # Removing unique constraint on 'FormM', fields ['number']
        db.delete_unique('form_m', ['number'])
