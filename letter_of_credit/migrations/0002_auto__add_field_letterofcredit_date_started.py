...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LetterOfCredit.date_started'
        db.add_column('letter_of_credit', 'date_started',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 11, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LetterOfCredit.date_started'
        db.delete_column('letter_of_credit', 'date_started')
    ...
    models = {
        ...
        u'letter_of_credit.letterofcredit': {
            ...
            'mf': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '12'})
        }
    }
