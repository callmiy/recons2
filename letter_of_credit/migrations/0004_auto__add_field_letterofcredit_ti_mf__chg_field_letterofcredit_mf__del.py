...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LetterOfCredit', fields ['mf']
        db.delete_unique('letter_of_credit', ['mf'])

        # Adding field 'LetterOfCredit.ti_mf'
        db.add_column('letter_of_credit', 'ti_mf',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True),
                      keep_default=False)


        # Changing field 'LetterOfCredit.mf'
        db.alter_column('letter_of_credit', 'mf', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))

    def backwards(self, orm):
        # Deleting field 'LetterOfCredit.ti_mf'
        db.delete_column('letter_of_credit', 'ti_mf')


        # Changing field 'LetterOfCredit.mf'
        db.alter_column('letter_of_credit', 'mf', self.gf('django.db.models.fields.CharField')(default='', max_length=13, unique=True))
        # Adding unique constraint on 'LetterOfCredit', fields ['mf']
        db.create_unique('letter_of_credit', ['mf'])
