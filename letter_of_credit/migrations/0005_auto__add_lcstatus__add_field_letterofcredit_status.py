...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LcStatus'
        db.create_table('lc_status', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
        ))
        db.send_create_signal(u'letter_of_credit', ['LcStatus'])

        # Adding field 'LetterOfCredit.status'
        db.add_column('letter_of_credit', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['letter_of_credit.LcStatus'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LcStatus'
        db.delete_table('lc_status')

        # Deleting field 'LetterOfCredit.status'
        db.delete_column('letter_of_credit', 'status_id')
    ...
    models = {
        ...
        u'letter_of_credit.letterofcredit': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['letter_of_credit.LcStatus']", 'null': 'True'}),
