...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormM.lc'
        db.add_column('form_m', 'lc',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['letter_of_credit.LCRegister'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormM.goods_description'
        db.add_column('form_m', 'goods_description',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormM.lc'
        db.delete_column('form_m', 'lc_id')

        # Deleting field 'FormM.goods_description'
        db.delete_column('form_m', 'goods_description')
