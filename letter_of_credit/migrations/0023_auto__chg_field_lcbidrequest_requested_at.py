...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LcBidRequest.requested_at'
        db.alter_column('lc_bid_request', 'requested_at', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'LcBidRequest.requested_at'
        db.alter_column('lc_bid_request', 'requested_at', self.gf('django.db.models.fields.DateField')(default=None))
