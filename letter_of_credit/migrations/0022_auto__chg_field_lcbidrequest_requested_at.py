...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lc_bid_request', 'requested_at', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'LcBidRequest.requested_at'
        db.alter_column('lc_bid_request', 'requested_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'letter_of_credit.lcbidrequest': {
            ...
            'requested_at': ('django.db.models.fields.DateField', [], {})
        },
