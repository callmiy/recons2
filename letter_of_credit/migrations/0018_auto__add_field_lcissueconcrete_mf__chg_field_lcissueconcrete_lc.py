...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LCIssueConcrete.mf'
        db.add_column('lc_issue_concrete', 'mf',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['letter_of_credit.FormM'], null=True),
                      keep_default=False)


        # Changing field 'LCIssueConcrete.lc'
        db.alter_column('lc_issue_concrete', 'lc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['letter_of_credit.LCRegister'], null=True))

    def backwards(self, orm):
        # Deleting field 'LCIssueConcrete.mf'
        db.delete_column('lc_issue_concrete', 'mf_id')


        # Changing field 'LCIssueConcrete.lc'
        db.alter_column('lc_issue_concrete', 'lc_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['letter_of_credit.LCRegister']))
    ...
    models = {
        ...
        'letter_of_credit.formm': {
            ...
            'number': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '13'})
        },
        ...
        'letter_of_credit.lcissueconcrete': {
            'Meta': {'object_name': 'LCIssueConcrete', 'db_table': "'lc_issue_concrete'"},
            'closed_at': ('django.db.models.fields.DateField', [], {}),
            'created_at': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['letter_of_credit.LCIssue']"}),
            'lc': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['letter_of_credit.LCRegister']", 'null': 'True'}),
            'mf': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['letter_of_credit.FormM']", 'null': 'True'})
        },
