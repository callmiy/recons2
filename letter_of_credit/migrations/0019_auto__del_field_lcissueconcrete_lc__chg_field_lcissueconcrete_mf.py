...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LCIssueConcrete.lc'
        db.delete_column('lc_issue_concrete', 'lc_id')


        # Changing field 'LCIssueConcrete.mf'
        db.alter_column('lc_issue_concrete', 'mf_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['letter_of_credit.FormM']))

    def backwards(self, orm):
        # Adding field 'LCIssueConcrete.lc'
        db.add_column('lc_issue_concrete', 'lc',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['letter_of_credit.LCRegister'], null=True),
                      keep_default=False)


        # Changing field 'LCIssueConcrete.mf'
        db.alter_column('lc_issue_concrete', 'mf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['letter_of_credit.FormM'], null=True))
    ...
    models = {
        ...
        'letter_of_credit.lcissueconcrete': {
            ...
            'mf': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['letter_of_credit.FormM']"})
        },
