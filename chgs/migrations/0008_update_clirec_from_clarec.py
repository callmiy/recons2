...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for chg in orm.charge.objects.filter(clarec_details__isnull=False):
            chg.clirec_details = chg.clarec_details
            chg.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        raise RuntimeError('Backward Migration disallowed!')
    ...
    models = {
        ...
        'chgs.charge': {
            ...
            'clirec_details': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'cr_acct': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['adhocmodels.NostroAccount']", 'null': 'True', 'db_column': "'cr_acct'", 'blank': 'True'}),
