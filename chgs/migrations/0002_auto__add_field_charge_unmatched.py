...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Charge.unmatched'
        db.add_column('chg', 'unmatched',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='unmatched_chgs', null=True, to=orm['unmatched.UnmatchedRecons']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Charge.unmatched'
        db.delete_column('chg', 'unmatched_id')
