...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('chg', 'customer', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['adhocmodels.Customer'], db_column='customer'))

        # Changing field 'Charge.lc_number'
        db.alter_column('chg', 'lc_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=16))

    def backwards(self, orm):

        # Changing field 'Charge.customer'
        db.alter_column('chg', 'customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adhocmodels.Customer'], null=True, db_column='customer'))

        # Changing field 'Charge.lc_number'
        db.alter_column('chg', 'lc_number', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
    ...
    models = {
        ...
        'chgs.charge': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['adhocmodels.Customer']", 'db_column': "'customer'"}),
            ...
            'unmatched': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'unmatched_chgs'", 'null': 'True', 'to': u"orm['unmatched.UnmatchedRecons']"}),
