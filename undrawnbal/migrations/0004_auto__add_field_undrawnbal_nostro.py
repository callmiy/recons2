...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UndrawnBal.nostro'
        db.add_column('undrawn', 'nostro',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='undrawn_nostros', to=orm['adhocmodels.NostroAccount']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UndrawnBal.nostro'
        db.delete_column('undrawn', 'nostro_id')
