...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UndrawnBal.applicant'
        db.delete_column('undrawn', 'applicant_id')


        # Changing field 'UndrawnBal.customer'
        db.alter_column('undrawn', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['adhocmodels.Customer']))

    def backwards(self, orm):
        # Adding field 'UndrawnBal.applicant'
        db.add_column('undrawn', 'applicant',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='applll_undrawn_bals', null=True, to=orm['adhocmodels.Customer']),
                      keep_default=False)


        # Changing field 'UndrawnBal.customer'
        db.alter_column('undrawn', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['adhocmodels.Customer']))
