...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UndrawnBal.date_cust_paid'
        db.add_column('undrawn', 'date_cust_paid',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UndrawnBal.date_cust_paid'
        db.delete_column('undrawn', 'date_cust_paid')
