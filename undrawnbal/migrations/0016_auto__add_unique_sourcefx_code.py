...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SourceFx', fields ['code']
        db.create_unique('source_fx', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'SourceFx', fields ['code']
        db.delete_unique('source_fx', ['code'])
    ...
    models = {
        ...
        u'undrawnbal.undrawnbal': {
            ...
            'claim_amt_ccy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'claim_amt_ccy'", 'to': u"orm['adhocmodels.Currency']"}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cust_undrawn_bals'", 'to': "orm['adhocmodels.Customer']"}),
            'date_cust_paid': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'estb_amt': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'estb_amt_ccy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'estb_amt_ccy'", 'to': u"orm['adhocmodels.Currency']"}),
            ...
            'nostro': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'undrawn_nostros'", 'to': u"orm['adhocmodels.NostroAccount']"}),
            ...
            'surplus_amt_ccy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'surplus_amt_ccy'", 'to': u"orm['adhocmodels.Currency']"}),
            'ticket_no': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'unmatched': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'unmatched_undrawns'", 'null': 'True', 'to': u"orm['unmatched.UnmatchedRecons']"})
        },
