...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UndrawnBal.unmatched'
        db.add_column('undrawn', 'unmatched',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='unmatched_undrawns', null=True, to=orm['unmatched.UnmatchedRecons']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UndrawnBal.unmatched'
        db.delete_column('undrawn', 'unmatched_id')
