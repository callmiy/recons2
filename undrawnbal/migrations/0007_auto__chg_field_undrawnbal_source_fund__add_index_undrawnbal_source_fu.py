...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'UndrawnBal.source_fund' to match new field type.
        db.rename_column('undrawn', 'source_fund', 'source_fund_id')
        # Changing field 'UndrawnBal.source_fund'
        db.alter_column('undrawn', 'source_fund_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['undrawnbal.SourceFx']))
        # Adding index on 'UndrawnBal', fields ['source_fund']
        db.create_index('undrawn', ['source_fund_id'])


    def backwards(self, orm):
        # Removing index on 'UndrawnBal', fields ['source_fund']
        db.delete_index('undrawn', ['source_fund_id'])


        # Renaming column for 'UndrawnBal.source_fund' to match new field type.
        db.rename_column('undrawn', 'source_fund_id', 'source_fund')
        # Changing field 'UndrawnBal.source_fund'
        db.alter_column('undrawn', 'source_fund', self.gf('django.db.models.fields.CharField')(max_length=4))
