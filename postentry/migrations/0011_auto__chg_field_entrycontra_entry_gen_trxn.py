...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntryContra.entry_gen_trxn'
        db.alter_column('entry_contra', 'entry_gen_trxn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postentry.EntryGeneratingTransaction'], null=True, db_column='entry_gen_trxn'))

    def backwards(self, orm):

        # Changing field 'EntryContra.entry_gen_trxn'
        db.alter_column('entry_contra', 'entry_gen_trxn', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['postentry.EntryGeneratingTransaction'], db_column='entry_gen_trxn'))
    ...
    models = {
        ...
        'postentry.entrycontra': {
            ...
            'entry_gen_trxn': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['postentry.EntryGeneratingTransaction']", 'null': 'True', 'db_column': "'entry_gen_trxn'"}),
