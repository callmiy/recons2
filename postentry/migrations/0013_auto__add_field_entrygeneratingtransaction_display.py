...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryGeneratingTransaction.display'
        db.add_column('entry_gen_trxn', 'display',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryGeneratingTransaction.display'
        db.delete_column('entry_gen_trxn', 'display')
