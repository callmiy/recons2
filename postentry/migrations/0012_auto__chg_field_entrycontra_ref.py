...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntryContra.ref'
        db.alter_column('entry_contra', 'ref', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

    def backwards(self, orm):

        # Changing field 'EntryContra.ref'
        db.alter_column('entry_contra', 'ref', self.gf('django.db.models.fields.CharField')(default=None, max_length=16))
    ...
    models = {
        ...
        'postentry.entrycontra': {
            ...
            'ref': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
