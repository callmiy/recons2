...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EntryGeneratingTransaction', fields ['short_name']
        db.create_unique('entry_gen_trxn', ['short_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'EntryGeneratingTransaction', fields ['short_name']
        db.delete_unique('entry_gen_trxn', ['short_name'])
