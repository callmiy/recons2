...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryContra.date_posted'
        db.add_column('entry_contra', 'date_posted',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryContra.date_posted'
        db.delete_column('entry_contra', 'date_posted')
